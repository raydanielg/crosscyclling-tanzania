        ...
        <div class="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center relative bg-[#f8f9fa] animate__animated animate__fadeInLeft order-1 md:order-2">
            ...
            <div class="max-w-sm mx-auto w-full">
                ...
                <div class="flex justify-center mb-4 animate__animated animate__zoomIn">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Coat_of_arms_of_Tanzania.svg/1200px-Coat_of_arms_of_Tanzania.svg.png" alt="Tanzania Logo" class="h-20 object-contain">
                </div>

                <h2 class="text-2xl font-bold text-center text-gray-800 mb-6 uppercase tracking-wider">Register</h2>
                    ...
                    <div class="space-y-3">
                        <div class="relative animate__animated animate__fadeInUp animate__delay-1s">
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus
                                class="w-full px-4 py-2.5 bg-[#d1dce8] border-2 border-transparent focus:border-blue-500 rounded text-sm text-gray-800 placeholder-gray-500 outline-none transition-all @error('name') border-red-500 @enderror"
                        ...
                        <div class="relative animate__animated animate__fadeInUp animate__delay-1s">
                            <div class="flex">
                                <span class="inline-flex items-center px-3 rounded-l bg-[#d1dce8] text-gray-700 text-sm font-bold border-2 border-transparent">+255</span>
                                <input id="phone" type="tel" name="phone" value="{{ old('phone') }}" required autocomplete="tel"
                                    class="w-full px-4 py-2.5 bg-[#d1dce8] border-2 border-transparent focus:border-blue-500 rounded-r text-sm text-gray-800 placeholder-gray-500 outline-none transition-all @error('phone') border-red-500 @enderror"
                                    placeholder="744428449">
                            </div>
                            @error('phone')
                                <span class="text-red-500 text-[10px] mt-1 block font-semibold">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="relative animate__animated animate__fadeInUp animate__delay-1s">
                            ...
                            <button type="button" @click="showPassword = !showPassword" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-800">
                                ...
                                <svg x-show="showPassword" x-cloak xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 012.513-4.043M9.88 9.88a3 3 0 104.24 4.24" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 00-3-3m0 0a2.99 2.99 0 00-2.12.88M3 3l18 18" />
                                </svg>
                            </button>
                            @error('password')
                                <span class="text-red-500 text-[10px] mt-1 block font-semibold">{{ $message }}</span>
                        ...
                        <div class="relative animate__animated animate__fadeInUp animate__delay-1s">
                            <input id="password-confirm" :type="showConfirm ? 'text' : 'password'" name="password_confirmation" required autocomplete="new-password"
                                class="w-full px-4 py-2.5 bg-[#d1dce8] border-2 border-transparent focus:border-blue-500 rounded text-sm text-gray-800 placeholder-gray-500 outline-none transition-all"
                                placeholder="Confirm Password">
                            <button type="button" @click="showConfirm = !showConfirm" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-800">
